...
UNSYNC_F5 = (
    ("K1ABC", "FN20", 0.18, -1080.0, 2.71, 1.00),
    ("W1AW", "FN31", 1.42, -870.0, 3.19, 0.92),
    ("N0QRP", "EM48", 0.61, -660.0, 2.88, 0.97),
    ("G0XYZ", "IO91", 2.04, -450.0, 3.36, 0.85),
    ("K6QSO", "CM87", 0.97, -240.0, 2.64, 0.90),
)
UNSYNC_FL10 = tuple((*station, "F") for station in UNSYNC_F5) + (
    ("DL1ABC", "JO62", 0.32, -30.0, 5.20, 0.95, "L"),
    ("F4ABC", "JN18", 1.18, 180.0, 5.47, 0.90, "L"),
    ("JA1ABC", "PM95", 0.74, 390.0, 5.71, 0.98, "L"),
    ("VK2ABC", "QF56", 1.63, 600.0, 5.33, 0.88, "L"),
    ("ZL1ABC", "RF73", 0.09, 810.0, 5.59, 0.93, "L"),
)
UNSYNC_F = (
    ("K1ABC", "FN20", 0.00, -1080.0, 2.70, 1.00),
    ("W1AW", "FN31", 0.55, -870.0, 3.10, 0.95),
    ("N0QRP", "EM48", 1.15, -660.0, 2.85, 0.90),
    ("G0XYZ", "IO91", 1.70, -450.0, 3.40, 0.88),
)
